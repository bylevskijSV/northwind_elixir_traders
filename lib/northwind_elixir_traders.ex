defmodule NorthwindElixirTraders do
  def get_application do
    ...
    c = s |> String.to_atom()
    %{atom: app, string: s, camilized: c}
  end

  def get_compiled_modules do
    get_application() |> Map.get(:atom) |> :application.get_key(:modules) |> elem(1)
  end
  ...
  def get_own_modules do
    ...
    |> Enum.filter(fn m -> Atom.to_string(m) |> String.contains?(app.string) end)
  end
end
